...

 {
    ...
    children: [
     ...
     //  },
      ...
      {path: '/home',name: '主页',icon:"social-html5",component: _import('Home')},
      {path: '/goods',name: '分类商品',redirect: '/goods/books',icon:'pie-graph',
        component: {render (c) { return c('router-view') }},
        children: [ {path: 'books',name: '图书',icon:'stats-bars',component: _import('goods/Books'), hidden:false, },
                    {path: 'clothes',name: '服饰',icon:'arrow-graph-up-right',component: _import('goods/Clothes')},
                    {path: 'foods',name: '食品',icon:'arrow-graph-up-right',component: _import('goods/Foods')},
                    {path: 'teches',name: '电子产品',icon:'ios-analytics',component: _import('goods/Teches')}
                  ]
      },
      {path: '/me',name: '个人中心',icon:"social-html5",component: _import('Me')},
      {path: '/upload',name: '上传商品',icon:"social-html5",component: _import('Upload')},
      {path: '/search',name: '搜索',icon:"social-html5",component: _import('Search')},
    ]
  },
